...
function payment(req,res){
    ...
    res.render("pages/payment", {title: "ATN-Shop Payment USER page", Notify: "",alls:all,_img:img,_id:id,prices:price,names:name,pricees:pricee,soluongs:sl, configHeader: configHeader , currpage: "Payment" });
}
